...
Standards are loaded during project init from the `standards/` library. See each file for conventions on naming, structure, styling, tooling, and anti-patterns.

- *(loaded during `/up-init` — see `docs/practices/`)*
...
|------:|-------|------|--------|------------|-------------|
| [0](./phases/phase-0.md) | Bootstrap: setup docs + phase plan | bootstrap | planned | - | - |

### Current focus

- Next runnable phase: **phase-0**
