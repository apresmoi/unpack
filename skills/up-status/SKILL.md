...
2. **Read `docs/index.md`** for the full documentation index and phase status table.

3. **Read all phase files** in `docs/phases/` (skip `phase-template.md`).

4. **Count conversations** in `conversations/` folder.
...
7. If `docs/index.md` is missing, tell the user the Unpack system isn't set up yet and suggest `/up-init` or `/up-adopt`.
