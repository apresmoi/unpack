...
This is the catalog of all available coding standards and best practices. During `/up-bootstrap` or `/up-adopt`, standards are automatically matched to your stack and copied into the project's `.unpack/docs/practices/` folder.
