...
- **`.unpack/docs/index.md`** as the project table of contents — agents read this first to understand structure
...
- **`.unpack/docs/index.md`** is the map: links to all specs, phases, practices, and decisions. Agents read this first to orient themselves
...
- **`.unpack/docs/practices/`** contains coding standards loaded for the project — agents read these before writing code
...
- **No undocumented conventions** — if agents should follow a pattern, write it in `.unpack/docs/practices/`
