...
1. **Read all project docs:**
   - All spec files: `.unpack/docs/specs/*.md`
   - All phase files: `.unpack/docs/phases/phase-*.md` (skip `phase-template.md`)
   - Project memory: `.unpack/docs/_meta/project-memory.md`
   - ADRs: `.unpack/docs/decisions/adr-*.md`
   - Index: `.unpack/docs/index.md`
