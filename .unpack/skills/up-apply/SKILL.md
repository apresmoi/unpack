...
4. **Move the conversation file** to `.unpack/conversations/NNN-name.md` (auto-increment based on existing files).
...
7. **Update `.unpack/docs/index.md`** with any new or changed phases and updated status table.
